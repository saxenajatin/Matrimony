...
-- No anon/authenticated storage policies.
-- App uses SUPABASE_SERVICE_ROLE_KEY on the server for upload/delete/signed URLs.

-- Default privacy rows for existing users
